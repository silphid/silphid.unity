...
namespace Silphid.Machina
{
    public static class IMachineExtensions
    {
        public static IObservable<Transition<TSource, TTarget>> Transitioning<TSource, TTarget>(this IMachine This) =>
            This.Transitions.Where(x => x.Source is TSource && x.Target is TTarget)
                .Select(x => new Transition<TSource, TTarget>((TSource) x.Source, (TTarget) x.Target));

        public static IObservable<Transition<TSource, TTarget>> Transitioning<TSource, TTarget>(
            this IMachine This,
            TSource source,
            TTarget target) =>
            ...
            Observable.Create<long>(
                observer =>
                {
                    ...
                    return new CompositeDisposable(
                        ...
                        This.Subscribe(
                            isState => everyUpdateSubscription.Disposable = isState
