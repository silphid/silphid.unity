...
{
    [TestFixture]
    public class MemoryCacheLoaderTest
    {
        ...
        {
            return _fixture.Load<string>(MockURI)
                           .Wait();
        }
        ...
        public void LoadTwiceTheSameURI_ReturnCachedObject()
        {
            ...
            _innerLoader.Received(1)
                        .Load<string>(Arg.Any<Uri>(), Arg.Any<Options>());
        ...
        public void BurstLoadWithoutCached_SecondRequestIsReturnFromBurst()
        {
            ...
            _fixture.Load<string>(MockURI)
                    .Subscribe(x => actualString1 = x);
        ...
        public void BurstLoadWithoutCachedError_SecondRequestIsReturnFromBurstWithError_ReturnInvalidOperation()
        {
            ...
            _fixture.Load<string>(MockURI)
                    .Subscribe(null, e => exception1 = e as InvalidOperationException);
            ...
            _fixture.Load<string>(MockURI)
                    .Subscribe(null, e => exception2 = e as InvalidOperationException);
        ...
        public void LoadWithDifferentURI_ReturnDifferentObjectAvoidingCache()
        {
            ...
            string actualString1 = null;
            _fixture.Load<string>(firstURI)
                    .Subscribe(x => actualString1 = x);

            Assert.That(actualString1, Is.Null);
            _innerLoader.Received(1)
                        .Load<string>(firstURI, Arg.Any<Options>());
            ...
            // Second request
            string actualString2 = null;
            _fixture.Load<string>(secondURI)
                    .Subscribe(x => actualString2 = x);

            // Should not return instantly from cache
            Assert.That(actualString2, Is.Null);
            _innerLoader.Received(1)
                        .Load<string>(secondURI, Arg.Any<Options>());
