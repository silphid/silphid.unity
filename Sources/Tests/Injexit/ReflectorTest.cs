...
namespace Silphid.Injexit.Test
{
    ...
    public class ReflectorTest
    {
        ...
        private class ClassWithMultipleMarkedConstructors
        {
            ...
            [Inject]
            public ClassWithMultipleMarkedConstructors(string str) {}
        }
        ...
        private class ClassWithMultipleConstructorsAndOnlyOneMarked
        {
            ...
            [Inject]
            public ClassWithMultipleConstructorsAndOnlyOneMarked(string str) {}
        }
        ...
        private class ClassWithSomeInjectableMembers
        {
            ...
            [Inject]
            private void InjectablePrivateMethod(object obj, string str) {}

            [Inject]
            public void InjectablePublicMethod(object obj, string str) {}
        ...
        private class ClassWithOptionalInjectableMembers
        {
            ...
            [Inject]
            private void InjectablePrivateMethod(object obj, [Optional] string str) {}

            [Inject]
            public void InjectablePublicMethod(object obj, [Optional] string str, object obj2 = null) {}
        }
        ...
        private class ClassWithIdentifiedInjectableMembers
        {
            ...
            [Inject]
            public void InjectableMethod(object obj, string str) {}
        }
        ...
        public void ClassWithMultipleUnmarkedConstructors_MissingInjectAttributeException()
        {
            ...
            Assert.That(
                ...
                Is.EqualTo(
                    $"Type {typeInfo.Type.Name} has multiple constructors, but none of them is marked with an [Inject] attribute to make it the default."));
        }
        ...
        public void ClassWithSomeInjectableMembers_ReturnsOnlyInjectables()
        {
            ...
            AssertContainsMember<string>(
                typeInfo.FieldsAndProperties,
                "_injectablePrivateField",
                "InjectablePrivateField");
            AssertContainsMember<string>(
                typeInfo.FieldsAndProperties,
                "InjectablePublicField",
                "InjectablePublicField");
            AssertContainsMember<string>(
                typeInfo.FieldsAndProperties,
                "InjectablePrivateProperty",
                "InjectablePrivateProperty");
            AssertContainsMember<string>(
                typeInfo.FieldsAndProperties,
                "InjectablePublicProperty",
                "InjectablePublicProperty");
        ...
        public void ClassWithNonWritableInjectableProperty_Throws()
        {
            ...
            Assert.That(
                exception.Message,
                Is.EqualTo(
                    $"Property {className}.{propertyName} is marked with [Inject] attribute, but has not setter."));
        }
        ...
        private void AssertContainsMember<T>(IEnumerable<InjectMemberInfo> members,
                                             string name,
        ...
        private void AssertMember<T>(InjectMemberInfo member,
                                     string name,
                                     string canonicalName,
                                     bool isOptional = false)
        {
