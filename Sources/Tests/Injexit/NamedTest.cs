...
#pragma warning disable CS0649
        ...
        {
            [Inject] [UsedImplicitly] internal Service Service1;

            [Inject] [UsedImplicitly] public Service Service2;
        }
#pragma warning restore CS0649
        ...
        public void SetUp()
        {
            ...
            _fixture.BindInstance(_service1)
                    .Named("Service1");
            _fixture.BindInstance(_service2)
                    .Named("Service2");
