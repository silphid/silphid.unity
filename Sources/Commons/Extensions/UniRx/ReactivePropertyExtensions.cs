...
namespace Silphid.Extensions
{
    ...
    {
        public static ReactiveProperty<T> ToWritableReactiveProperty<T>(this IReadOnlyReactiveProperty<T> source) =>
            source.ToWritableReactiveProperty(source.Value);

        public static IDisposable BindTwoWayTo<TSource, TTarget>(this IReactiveProperty<TSource> This,
