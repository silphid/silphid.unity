...
namespace Silphid.Extensions
{
    public static class IObservableQuaternionExtensions
    {
        ...
        /// </summary>
        public static IObservable<Quaternion>
            Lerp(this IObservable<float> This, Quaternion source, Quaternion target) =>
        ...
        /// </summary>
        public static IObservable<Quaternion>
            Slerp(this IObservable<float> This, Quaternion source, Quaternion target) =>
        ...
        /// </summary>
        [Pure]
        public static IObservable<Quaternion> Bezier(this IObservable<float> This,
                                                     Quaternion source,
                                                     Quaternion target,
                                                     Quaternion handle) =>
