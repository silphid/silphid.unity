...
namespace Silphid.Extensions
{
    public struct CollectionAddRemoveEvent<T> : IEquatable<CollectionAddRemoveEvent<T>>
    {
        ...
        public CollectionAddRemoveEvent(int index, T value, bool isAdded)
            : this()
        {
            Index = index;
            Value = value;
    ...
    {
        public static IObservable<CollectionAddRemoveEvent<T>> ObserveCurrentAddRemove<T>(
            this IReadOnlyReactiveCollection<T> This) =>
