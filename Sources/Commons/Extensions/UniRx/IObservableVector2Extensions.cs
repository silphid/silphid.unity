...
namespace Silphid.Extensions
{
    public static class IObservableVector2Extensions
    {
        ...
        /// </summary>
        [Pure]
        public static IObservable<Vector2> Bezier(this IObservable<float> This,
                                                  Vector2 source,
                                                  Vector2 target,
                                                  Vector2 handle) =>
        ...
        [Pure]
        public static IObservable<Vector2> Smooth(this IObservable<Vector2> This,
        ...
        /// </summary>
        [Pure]
        public static IObservable<Vector2> ElasticClamp(this IObservable<Vector2> This,
                                                        Vector2 min,
                                                        Vector2 max,
                                                        float elasticity) =>
        ...
        /// </summary>
        [Pure]
        public static IObservable<Vector2> Velocity(this IObservable<Vector2> This,
                                                    float smoothness = Smoothness.Responsive,
                                                    IObservable<Vector2> rawVelocities = null,
