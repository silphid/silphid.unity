...
namespace Silphid.Extensions
{
    public static class IObservableVector3Extensions
    {
        ...
        /// </summary>
        [Pure]
        public static IObservable<Vector3> Bezier(this IObservable<float> This,
                                                  Vector3 source,
                                                  Vector3 target,
                                                  Vector3 handle) =>
        ...
        [Pure]
        public static IObservable<Vector3> Smooth(this IObservable<Vector3> This,
        ...
        /// </summary>
        [Pure]
        public static IObservable<Vector3> ElasticClamp(this IObservable<Vector3> This,
                                                        Vector3 min,
                                                        Vector3 max,
                                                        float elasticity) =>
        ...
        /// </summary>
        [Pure]
        public static IObservable<Vector3>
            ElasticClamp(this IObservable<Vector3> This, Bounds bounds, float elasticity) =>
        ...
        /// </summary>
        [Pure]
        public static IObservable<Vector3> Velocity(this IObservable<Vector3> This,
                                                    float smoothness = Smoothness.Responsive,
                                                    IObservable<Vector3> rawVelocities = null,
