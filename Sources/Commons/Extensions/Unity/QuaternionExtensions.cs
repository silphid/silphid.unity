...
namespace Silphid.Extensions
{
    public static class QuaternionExtensions
    {
        ...
        /// </summary>
        [Pure]
        public static Quaternion Bezier(this float This,
                                        Quaternion source,
                                        Quaternion target,
                                        Quaternion sourceHandle,
                                        Quaternion targetHandle)
        {
        ...
        public static bool IsAlmostEqualTo(this Quaternion This, Quaternion other, float epsilon) =>
            ...
            This.z.IsAlmostEqualTo(other.z, epsilon) && This.w.IsAlmostEqualTo(other.w, epsilon);
