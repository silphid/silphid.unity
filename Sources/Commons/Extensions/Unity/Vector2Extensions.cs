...
namespace Silphid.Extensions
{
    public static class Vector2Extensions
    {
        ...
        /// </summary>
        [Pure]
        public static Vector2 Bezier(this float This,
                                     Vector2 source,
                                     Vector2 target,
                                     Vector2 sourceHandle,
                                     Vector2 targetHandle)
        {
        ...
        public static bool IsAlmostZero(this Vector2 This) =>
            This.x.IsAlmostZero() && This.y.IsAlmostZero();

        [Pure]
        public static bool IsAlmostEqualTo(this Vector2 This, Vector2 other) =>
            This.x.IsAlmostEqualTo(other.x) && This.y.IsAlmostEqualTo(other.y);

        [Pure]
        public static bool IsAlmostEqualTo(this Vector2 This, Vector2 other, float epsilon) =>
            This.x.IsAlmostEqualTo(other.x, epsilon) && This.y.IsAlmostEqualTo(other.y, epsilon);
        ...
        public static Vector2 RoundToInt(this Vector2 This) =>
            new Vector2(This.x.RoundToInt(), This.y.RoundToInt());

        [Pure]
        public static Vector2Int RoundToVector2Int(this Vector2 This) =>
            new Vector2Int(This.x.RoundToInt(), This.y.RoundToInt());

        [Pure]
        public static Vector2 RoundToInterval(this Vector2 This, float increment) =>
            new Vector2(This.x.RoundToInterval(increment), This.y.RoundToInterval(increment));
        ...
        [Pure]
        public static Vector2 FlippedY(this Vector2 This) =>
            new Vector2(This.x, -This.y);

        [Pure]
        public static Vector2 FlippedXY(this Vector2 This) => new Vector2(This.y, This.x);
        ...
        /// </summary>
        public static Vector2 Min(this Vector2 This, Vector2 min) =>
            new Vector2(This.x.Min(min.x), This.y.Min(min.y));

        /// <summary>
        /// Returns the maximum value between this and another value
        /// </summary>
        public static Vector2 Max(this Vector2 This, Vector2 max) =>
            new Vector2(This.x.Max(max.x), This.y.Max(max.y));

        /// <summary>
        /// Returns value clamped to be greater than or at least equal to given value
        /// </summary>
        public static Vector2 AtLeast(this Vector2 This, Vector2 min) =>
            This.Max(min);

        /// <summary>
        /// Returns value clamped to be at less than or at most equal to given value
        /// </summary>
        public static Vector2 AtMost(this Vector2 This, Vector2 max) =>
            This.Min(max);
        ...
        public static Vector2 ElasticClamp(this Vector2 This, Vector2 min, Vector2 max, float elasticity) =>
            new Vector2(This.x.ElasticClamp(min.x, max.x, elasticity), This.y.ElasticClamp(min.y, max.y, elasticity));
        ...
        public static Vector2 Transform(this Vector2 This, RectTransform source, RectTransform target) =>
            target.InverseTransformPoint(source.position + This.ToVector3())
                  .ToVector2();
