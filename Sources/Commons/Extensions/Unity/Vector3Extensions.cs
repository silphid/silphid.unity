...
namespace Silphid.Extensions
{
    public static class Vector3Extensions
    {
        ...
        /// </summary>
        [Pure]
        public static Vector3 Bezier(this float This,
                                     Vector3 source,
                                     Vector3 target,
                                     Vector3 sourceHandle,
                                     Vector3 targetHandle)
        {
        ...
        public static bool IsAlmostZero(this Vector3 This) =>
            This.x.IsAlmostZero() && This.y.IsAlmostZero() && This.z.IsAlmostZero();

        [Pure]
        public static bool IsAlmostEqualTo(this Vector3 This, Vector3 other) =>
            This.x.IsAlmostEqualTo(other.x) && This.y.IsAlmostEqualTo(other.y) && This.z.IsAlmostEqualTo(other.z);
        ...
        public static bool IsWithin(this Vector3 This, Bounds bounds) =>
            This.x >= bounds.min.x && This.x <= bounds.max.x && This.y >= bounds.min.y && This.y <= bounds.max.y &&
            This.z >= bounds.min.z && This.z <= bounds.max.z;

        [Pure]
        public static bool IsWithin(this Vector3 This, Vector3 min, Vector3 max) =>
            This.x >= min.x && This.x <= max.x && This.y >= min.y && This.y <= max.y && This.z >= min.z &&
            This.z <= max.z;
        ...
        public static Vector3 Round(this Vector3 This) =>
            new Vector3(This.x.Round(), This.y.Round(), This.z.Round());

        [Pure]
        public static Vector3 RoundToInt(this Vector3 This) =>
            new Vector3(This.x.RoundToInt(), This.y.RoundToInt(), This.z.RoundToInt());
        ...
        public static Vector3 Clamp(this Vector3 This, Vector3 min, Vector3 max) =>
            new Vector3(This.x.Clamp(min.x, max.x), This.y.Clamp(min.y, max.y), This.z.Clamp(min.z, max.z));
