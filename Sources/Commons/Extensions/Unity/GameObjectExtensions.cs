...
namespace Silphid.Extensions
{
    public static class GameObjectExtensions
    {
        ...
        public static TComponent GetRequiredComponent<TComponent>(this GameObject This)
        {
            ...
            if (component == null)
                throw new InvalidOperationException(
                    $"GameObject is required to have a {typeof(TComponent).Name} component: {This.gameObject.ToHierarchyPath()}");
        ...
        public static bool IsDescendantOf(this GameObject This, GameObject other) =>
            other != null && (This?.transform.Ancestors()
                                   .Any(x => x == other) ?? false);

        public static bool IsAncestorOf(this GameObject This, GameObject other) =>
            This != null && (other?.transform.Ancestors()
                                   .Any(x => x == This) ?? false);
        ...
        public static Tuple<List<GameObject>, List<GameObject>> DivergingBranchesWith(
        ...
        public static void SetParent(this GameObject This, GameObject parent, bool worldPositionStays = false) =>
