...
namespace Silphid.Extensions
{
    ...
    {
        private static IObservable<Unit> TweenTo<T>(this IReactiveProperty<T> This, Func<Tween> selector, Ease ease =
 Ease.Linear, bool completeTweenOnDispose = false) =>
        ...
        public static IObservable<Unit> TweenTo(this IReactiveProperty<float> This, float target, float duration, Ease ease
 = Ease.Linear, bool completeTweenOnDispose = false) =>
            This.TweenTo(() => DOTween.To(() => This.Value, x => This.Value =
 x, target, duration), ease, completeTweenOnDispose);

        public static IObservable<Unit> TweenTo(this IReactiveProperty<float?> This, float target, float duration, Ease ease
 = Ease.Linear, bool completeTweenOnDispose = false) =>
            This.TweenTo(() => DOTween.To(() => This.Value ?? 0f, x => This.Value =
 x, target, duration), ease, completeTweenOnDispose);

        public static IObservable<Unit> TweenTo(this IReactiveProperty<TimeSpan> This, TimeSpan target, float duration, Ease ease
 = Ease.Linear, bool completeTweenOnDispose = false) =>
            This.TweenTo(() => DOTween.To(() => This.Value.Ticks, x => This.Value =
 TimeSpan.FromTicks(x), target.Ticks, duration), ease, completeTweenOnDispose);

        public static IObservable<Unit> TweenTo(this IReactiveProperty<TimeSpan?> This, TimeSpan target, float duration, Ease ease
 = Ease.Linear, bool completeTweenOnDispose = false) =>
            This.TweenTo(() => DOTween.To(() => This.Value?.Ticks ?? 0, x => This.Value =
 TimeSpan.FromTicks(x), target.Ticks, duration), ease, completeTweenOnDispose);
