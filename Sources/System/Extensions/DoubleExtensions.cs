...
namespace Silphid.Extensions
{
    public static class DoubleExtensions
    {
        ...
        /// </summary>
        [Pure]
        public static double Bezier(this double This,
                                    double source,
                                    double target,
                                    double sourceHandle,
                                    double targetHandle)
        ...
        /// </summary>
        [Pure]
        public static double TransposeClamp(this double This,
                                            double minFrom,
                                            double maxFrom,
                                            double minTo,
                                            double maxTo) =>
        ...
        public static double Clamp(this double This, double min, double max) =>
            min < max
                ? AtMost(AtLeast(This, min), max)
                : AtMost(AtLeast(This, max), min);
