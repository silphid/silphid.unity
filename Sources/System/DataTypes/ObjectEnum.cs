    ...
    public abstract class ObjectEnum<T> where T : ObjectEnum<T>
    {
        ...
        private static void ThrowBothImplicitAndExplicitIds()
        {
            throw new NotSupportedException(
                "Object enum {0} cannot have both implicit and explicit ids".Formatted(typeof(T).Name));
        }
        ...
        public static List<T> All =>
            _all ?? (_all = typeof(T).GetFields(BindingFlags.Static | BindingFlags.Public)
        ...
        {
            return GetType()
                      .GetHashCode() * 397 ^ Name.GetHashCode();
        }
