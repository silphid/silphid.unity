...
namespace Silphid.Sequencit
{
    public class LiveSequence : SequencerBase, ISequencer, IDisposable
    {
        ...
        public IDisposable Subscribe(ICompletableObserver observer)
        {
            ...
            return new CompositeDisposable(Disposable.Create(Complete), _subscriptionLapse.Subscribe(observer));
        }
        ...
        private bool Truncate(object item, bool isInclusive)
        {
            ...
            var count = index.Value + (isInclusive
                                           ? 0
                                           : 1);
        ...
        private void StartNext()
        {
            ...
            _currentExecution = observable.Finally(
                                               () =>
                                               {
                                                   _isExecuting = false;
                                                   StartNext();
