...
namespace Silphid.Tweenzup
{
    ...
    {
        public TweenVector3ToShiftingTargetCompletable(IReactiveProperty<Vector3> property,
        ...
        protected override ICompletable Tween(IReactiveProperty<Vector3> property,
                                              Vector3 target,
                                              float duration,
                                              Vector3 velocity,
                                              IEaser easer) =>
