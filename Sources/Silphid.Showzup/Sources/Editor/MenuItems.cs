...
namespace Silphid.Showzup
{
    public class MenuItems
    {
        ...
        {
            var go = Create<ItemControl>(x => x.Container = x.gameObject);
            Complete(go);
        }
        ...
        {
            var go = CreateTransitionControl<NavigationControl>(null, x =>
            {
        ...
        {
            return Create<T>(parent, x => x.Container = x.gameObject);
        }
        
        private static GameObject CreateTransitionControl<T>(GameObject parent = null, Action<T> action = null) where T : TransitionControl
        {
            return Create<T>(parent, x =>
            {
