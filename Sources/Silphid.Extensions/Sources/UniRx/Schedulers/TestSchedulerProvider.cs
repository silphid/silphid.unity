...
namespace Silphid.Extensions.UniRx.Schedulers
{
    public class TestSchedulerProvider : ISchedulerProvider
    {
        ...
        public TestScheduler MainThreadEndOfFrame => _mainThreadEndOfFrame ?? (_mainThreadEndOfFrame = new TestScheduler());
        public TestScheduler MainThreadFixedUpdate => _mainThreadFixedUpdate ?? (_mainThreadFixedUpdate = new TestScheduler());
        public TestScheduler MainThreadIgnoreTimeScale => _mainThreadIgnoreTimeScale ?? (_mainThreadIgnoreTimeScale = new TestScheduler());
