...
namespace Silphid.Injexit
{
    public class LogConfigurator
    {
        ...
        public LogConfigurator(string dataPath = "",
                               string resourcePath = "Assets/Resources/",
                               string fileName = "Log4net")
        {
            _dataPath = dataPath;
        ...
        private void Watch()
        {
            ...
            {
                Debug.LogWarning(
                    "Log config file not found for watching changes, " +
        ...
        private void Load()
        {
            var text = LoadFromDataPath() ?? LoadFromResources();
        ...
        private string LoadFromResources()
        {
            ...
            return Resources.Load<TextAsset>(_fileName)
                            .text;
        }
    }
}