...
namespace Silphid.Injexit
{
    ...
    {
        /// <summary>
        /// Decorates given container with a scope.
        /// </summary>
        public static IContainer Scoped(this IContainer This, IScope scope) =>
            scope != null
                ? new ScopedContainer(This, scope)
                : This; 
        ...
        /// <summary>
        /// Creates child container with extra bindings specified by dictionary.
        /// </summary>
        public static IContainer
            UsingInstances(this IContainer This, [CanBeNull] IDictionary<Type, object> instances) =>
        ...
        public static IBinding BindTypedFactory<T1, TAbstraction>(this IContainer This) =>
            This.BindInstance<Func<Type, T1, TAbstraction>>(
                (type, t1) => (TAbstraction) This.UsingInstance(t1)
                                                 .Resolve(type));

        public static IBinding BindTypedFactory<T1, T2, TAbstraction>(this IContainer This) =>
            This.BindInstance<Func<Type, T1, T2, TAbstraction>>(
                (type, t1, t2) => (TAbstraction) This.UsingInstances(t1, t2)
                                                     .Resolve(type));

        public static IBinding BindTypedFactory<T1, T2, T3, TAbstraction>(this IContainer This) =>
            This.BindInstance<Func<Type, T1, T2, T3, TAbstraction>>(
                (type, t1, t2, t3) => (TAbstraction) This.UsingInstances(t1, t2, t3)
                                                         .Resolve(type));

        public static IBinding BindTypedFactoryWithParameters<TAbstraction>(this IContainer This) =>
            This.BindInstance<Func<Type, object[], TAbstraction>>(
                (type, instances) => (TAbstraction) This.UsingInstances(instances)
                                                        .Resolve(type));

        public static IBinding
            BindTypedFactoryWithParameters<TFactoryAbstraction, TFactory, TAbstraction>(this IContainer This)
            where TFactory : TFactoryAbstraction =>
            This.Bind<TFactoryAbstraction, TFactory>()
                .Using(
                     x => x.BindInstance<Func<Type, object[], TAbstraction>>(
                         (type, instances) => (TAbstraction) This.UsingInstances(instances)
                                                                 .Resolve(type)));
        ...
        public static IBinding BindDefaultFactory<T1, TAbstraction>(this IContainer This) =>
            This.BindInstance<Func<T1, TAbstraction>>(
                t1 => This.UsingInstance(t1)
                          .Resolve<TAbstraction>());

        public static IBinding BindDefaultFactory<T1, T2, TAbstraction>(this IContainer This) =>
            This.BindInstance<Func<T1, T2, TAbstraction>>(
                (t1, t2) => This.UsingInstances(t1, t2)
                                .Resolve<TAbstraction>());

        public static IBinding BindDefaultFactory<T1, T2, T3, TAbstraction>(this IContainer This) =>
            This.BindInstance<Func<T1, T2, T3, TAbstraction>>(
                (t1, t2, t3) => This.UsingInstances(t1, t2, t3)
                                    .Resolve<TAbstraction>());
