...
namespace Silphid.Showzup
{
    ...
    public class TypeToTypeMapping : Mapping
    {
        ...
        public override bool Matches(string filter) =>
            base.Matches(filter) || Target.Name.CaseInsensitiveContains(filter) ||
        ...
        public override string ToString()
        {
            ...
            var implicitVariants = _implicitVariants != null
                                       ? _implicitVariants.Any()
                                             ? $" ({_implicitVariants})"
                                             : ""
                                       : "null";

            return $"{Source?.Name.ToStringOrNullLiteral()} => " + $"{Target?.Name.ToStringOrNullLiteral()}" +
        ...
        public override bool IsValid =>
            base.IsValid && _target != null && _implicitVariants != null;
    }
}