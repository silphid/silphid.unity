...
namespace Silphid.Showzup
{
    public class CarrouselControl : ListControl
    {
        ...
        private struct Item
        {
            ...
            public Item(RectTransform rectTransform, float referencePosition)
                : this()
            {
            ...
            _items.WhereNotNull()
                  ...
                  .Subscribe(
                       x =>
                       {
                           ...
                           FindShortestPath(
                               _items.Value[x.Value]
                                     .ReferencePosition);

                           _motionDisposable.Disposable = _currentPosition.TweenTo(
                                                                               _items.Value[x.Value]
                                                                                     .ReferencePosition,
                                                                               MotionDuration,
                                                                               Easer.OutQuadratic)
        ...
        private void UpdateAll(float currentPosition)
        {
            ...
            foreach (var item in _items.Value)
            {
                ...
                item.RectTransform.anchoredPosition = item.RectTransform.anchoredPosition.WithX(pos);
            }
        }
    }
}