    ...
    public class CustomInputModule : PointerInputModule
    {
        ...
        protected bool SendSubmitEventToSelectedObject()
        {
            ...
            if (Input.GetButtonDown(m_SubmitButton))
                _navigationService.ExecuteBubbling(
        ...
        protected void ProcessMouseEvent(int id)
        {
            ...
            ProcessMousePress(
                mouseData.GetButtonState(PointerEventData.InputButton.Right)
                         .eventData);
            ProcessDrag(
                mouseData.GetButtonState(PointerEventData.InputButton.Right)
                         .eventData.buttonData);
            ProcessMousePress(
                mouseData.GetButtonState(PointerEventData.InputButton.Middle)
                         .eventData);
            ProcessDrag(
                mouseData.GetButtonState(PointerEventData.InputButton.Middle)
                         .eventData.buttonData);
